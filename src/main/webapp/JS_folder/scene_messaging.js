...
socket.onmessage = function(event) {
    ...
    if(indice == 1){
        ...
        if(TabReceivedMessage[6].localeCompare(null) == 0){
           contact_image.src="<%=request.getContextPath()%>/user_images/default_image.png";
        }else{
            contact_image.src="<%=request.getContextPath()%>/user_images/"+TabReceivedMessage[6];
        }
        ...
        function select_contact(){
            if(contact_container.style.border == "1.2px solid red"){
                ...
                contact_container.style.border="1.2px solid red";
